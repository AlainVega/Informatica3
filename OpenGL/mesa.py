...
def mesa():
    ...
    rectaLoop([t0, t1, t2, t3], (0.6, 0.1, 0.6))
    rectaLoop([t4, t5, t6, t7], (0.6, 0.1, 0.6))

    cara([t1, t5, t6, t2], (0.6, 0.1, 0.6))
    cara([t2, t6, t7, t3], (0.6, 0.1, 0.6))
    cara([t0, t4, t5, t1], (0.6, 0.1, 0.6))
    cara([t0, t4, t7, t3], (0.6, 0.1, 0.6))

    cara([t4, t5, t6, t7], (0.1, 0,7, 0,4))
